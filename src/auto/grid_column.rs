...
impl GridColumn {
    ...
    /// Creates a new builder-pattern struct instance to construct [`GridColumn`] objects.
    ///
    /// This method returns an instance of [`GridColumnBuilder`](crate::builders::GridColumnBuilder) which can be used to create [`GridColumn`] objects.
    pub fn builder() -> GridColumnBuilder {
        GridColumnBuilder::new()
    }
...
// rustdoc-stripper-ignore-next
/// A [builder-pattern] type to construct [`GridColumn`] objects.
///
/// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct GridColumnBuilder {
    builder: glib::object::ObjectBuilder<'static, GridColumn>,
}

impl GridColumnBuilder {
    fn new() -> Self {
        Self {
