...
extern "C" {
    ...
    pub fn panel_statusbar_add_prefix(self_: *mut PanelStatusbar, widget: *mut gtk::GtkWidget);
    pub fn panel_statusbar_add_suffix(self_: *mut PanelStatusbar, widget: *mut gtk::GtkWidget);
